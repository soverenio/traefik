...
type ConfigurationWatcher struct {
	...
	configurationListeners []func(dynamic.Message)
...
func (c *ConfigurationWatcher) AddListener(listener func(dynamic.Message)) {
	if c.configurationListeners == nil {
		c.configurationListeners = make([]func(dynamic.Message), 0)
	}
